...
const CommonButton = ({ buttonContent, classPass }) => {
  return (
    <Link
      class={`cursor-pointer relative bg-primary mt-[32px] mb-[40px] py-2 rounded-full min-w-[100px] w-[248px] h-[48px] min-h-[29px] group max-w-full flex items-center justify-start hover:bg-brand transition-all duration-[0.8s] ease-[cubic-bezier(0.510,0.026,0.368,1.016)] shadow-[inset_1px_2px_5px_#00000080] ${classPass}`}
    >
